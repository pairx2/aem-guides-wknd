# AEM ADC Divisional Apps Project (6.5)

This project has been created for AN Division sites using aem-65-hello-world-apps as a template.
...
If you have a running AEM instance you can build and package the whole project and deploy into AEM with
    ...
    mvn clean install -Pabbott,autoInstallPackage

Or to deploy it to a publish instance, run

    mvn clean install -Pabbott,autoInstallPackagePublish

Or alternatively

    mvn clean install -Pabbott,autoInstallPackage -Daem.port=4503
