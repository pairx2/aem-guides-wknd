# AEM Abbott Freestyle Libre DE(6.5)
...
* ui.content: contains project specific mutable content. This can also contain the base content structure of the project. eg: /content/adc/freestylelibrede, /content/dam/adc/freestylelibrede, etc.
