...
(function($, ns, channel, window) {
    ...
    var PN_Panel_Icon= "iconClass";
	var PN_Panel_Event= "accountNavEvent";
    ...
    var selectors = {
        ...
        item: {
            ...
            accountNavEvent: "[data-cmp-hook-childreneditor='accountNavEvent']",
            input: "[data-cmp-hook-childreneditor='itemTitle']",
            input1: "[data-cmp-hook-childreneditor='itemImage']",
                                    ...
                                    selectList.on(getSelectListChangeEvent(onCloud) + NS, getSelectListSelector(onCloud), function(event) {
                                        ...
                                        if (components.length > 0) {
                                            ...
                                            Coral.commons.nextFrame(function() {
                                                ...
                                                var input1 = item.querySelectorAll(selectors.item.input1)[0];
                                                input1.name = "./" + name +"/" + PN_Panel_Icon;
												
												var accountNavEvent = item.querySelectorAll(selectors.item.accountNavEvent)[0];
                                                accountNavEvent.name = "./" + name +"/" + PN_Panel_Event;
