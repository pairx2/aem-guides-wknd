      ...
      !(function () {
        ...
        function a() {
          ...
          if ((i == t && a.find("a").on("click", o), !(c.length > 0))) {
            ...
            var p = "";
            l.find(".m-popup-content")
              .find("section.a-container")
              .find("div.a-container__column")
              .each(function () {
                e(this).remove(), (p += e(this).html());
              });
            var s = l.find(".m-popup-content").html(),
              u = e.parseHTML(
            ...
            d.append(u),
              l.find(".m-popup-content").remove(),
              l.find(".m-popup-content-footer").remove(),
