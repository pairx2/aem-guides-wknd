                ...
                success: function(responseVal) {
					...
					if(orderid == 0){
                        ...
                        if (element.productId != undefined){
                            tr.append('<td><a id="edit-product" href="/secure/product/request/edit.html?productId='+productiD+'&orderId='+orderNo+'&marketId='+marketiD+'"productId="'+productiD+'" orderId="'+orderNo+'" marketId="'+marketiD+'">Edit Product</a></td>' );
                        }
                        else{
                                tr.append('<td></td>').hide();
                        }
                        ...
                        $(document).on("focus", "#edit-product", function(e){
                            ...
                            localStorage.setItem("previewType", "Edit");
                        });
                    }
