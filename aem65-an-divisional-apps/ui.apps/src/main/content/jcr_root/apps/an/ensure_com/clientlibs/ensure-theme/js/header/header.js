...
$(document).ready(function () {
    ...
    $('#section-ensure-header').parent('.container').addClass('a-container--header');
    $('#section-ensure-footer').parent('.container').addClass('a-container--footer');
    ...
    $('#ensure-header .m-link-stack .m-link-stack--header .abt-icon-down-arrow').click(function (e) {
    ...
    $('.abt-icon').on("click", function () {
        setTimeout(() => {
            if ($('.a-search').hasClass('a-search--expand')) {
                $('#section-a-container-ensure-header').css('display', 'none');
            }
            else {
                $('#section-a-container-ensure-header').css('display', 'flex');
            }
        }, 0);
    ...
    $(document).on('click touchstart', '.a-search--icon-right',  function() {
        $('.navbar').removeClass('show');
    });
    if ($(window).width() < 992) {
        let $footercolumn = $('#ensure-footer .o-footer__link-wrapper');
