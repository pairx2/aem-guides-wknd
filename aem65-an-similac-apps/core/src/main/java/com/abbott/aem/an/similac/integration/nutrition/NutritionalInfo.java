...
public class NutritionalInfo {
	...
	@Override
	public int hashCode() {
		return Objects.hash(lineNumber, nutritionCategory, nutritionName, nutritionValue, percentDV, percentRDI);
	}
	...
	public boolean equals(Object obj) {
		...
		NutritionalInfo other = (NutritionalInfo) obj;
		return Objects.equals(lineNumber, other.lineNumber)
				&& Objects.equals(nutritionCategory, other.nutritionCategory)
				&& Objects.equals(nutritionName, other.nutritionName)
				&& Objects.equals(nutritionValue, other.nutritionValue) && Objects.equals(percentDV, other.percentDV)
				&& Objects.equals(percentRDI, other.percentRDI);
	}
}
