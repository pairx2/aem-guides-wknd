...
const contains = (childNode,target)=>{
    if(childNode){
        if(target && window.msCrypto && target.toString() === "[object SVGElementInstance]"){
            return true;
        }
        return childNode.firstChild.isEqualNode(target) ? false : childNode.contains(target);
    }
    return false;
};
...
export default class OutsideClickHandler extends React.Component {
    ...
    onMouseDown(e) {
        ...
        if (!isDescendantOfRoot && e.target.parentElement !== null) {
