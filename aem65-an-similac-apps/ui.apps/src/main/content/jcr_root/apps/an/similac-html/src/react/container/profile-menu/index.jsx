...
const MenuItem = ({ label, aemURL, magURL, extraPatternCheck, cookieKey, hideInGroup = "", magentoGroupName = "", child, magData = {}, userType = "" }) => {
    let urlLink = aemURL;
...
const ProfileMenu = ({ data: menuData }) => {
    ...
    return (
        <div className="text-left">
            {mobileLabel && <div
                className="side-nav-mob d-block d-md-none"
                onClick={onClick}
            >
                {mobileLabel}
