...
(function ($, CUI) {
    let GROUP = "ardx-experience-aem",
        ...
        TITLE = "Color Picker",
        ICON = "textColor",
        PICKER_URL = "/apps/ardx/division/components/content/text/eaem-touchui-dialog-rte-color-picker/color-picker-popover/_cq_dialog.html";
    ...
    let ColorPickerPlugin = new Class({
        ...
        execute: function (id, value, envOptions) {
            ...
            function getPickerIFrameUrl(colorName) {
                let url = PICKER_URL + "?" + REQUESTER + "=" + GROUP;
                
                if (!_.isEmpty(colorName)) {
                    url = url + "&" + PICKER_NAME_IN_POPOVER + "=" + colorName;
                }
    ...
    function addDialogTemplate() {
        ...
        let html = "<iframe width='500px' height='400px' frameBorder='0' src='" + url + "'></iframe>";
...
(function ($, $document) {
    let SENDER = "ardx-experience-aem",
        REQUESTER = "requester",
        COLOR = "color",
    ...
    function adjustFooter($dialog) {
        let $footer = $dialog.find("._coral-Dialog-footer");
