...
public abstract class AbstractDispatcherCacheHeaderFilter implements Filter {
    ...
    private final List<ServiceRegistration> filterRegistrations = new ArrayList<>();

    private boolean allowAllParams = false;
    private List<String> passThroughParams = new ArrayList<>();
    private List<String> blockParams = new ArrayList<>();
     ...
     */
    protected abstract void doActivate(ComponentContext context) throws ConfigurationException;
    ...
    protected final void activate(ComponentContext context) throws  ConfigurationException {
        ...
        for (String pattern : filters) {
            ...
            if (PROP_DISPATCHER_FILTER_ENGINE_SLING.equals(filterEngine)) {
