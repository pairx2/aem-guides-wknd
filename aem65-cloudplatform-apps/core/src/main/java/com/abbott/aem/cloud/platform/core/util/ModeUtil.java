...
public final class ModeUtil {
    ...
    public void configure() throws ConfigurationException {
        ...
        isAuthor = identifyRunModesService.getAllRunModes().contains(Externalizer.AUTHOR);
        isPublish = identifyRunModesService.getAllRunModes().contains(Externalizer.PUBLISH);
