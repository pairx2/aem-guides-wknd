...
/***/ (function(module, exports, __webpack_require__) {
  ...
  function webViewerInitialized() {
    ...
    var file_url = 'file' in params ? params.file : _app_options.AppOptions.get('defaultUrl');
    file = (localStorage.getItem('lastPdfOpened')) && JSON.parse(localStorage.getItem('lastPdfOpened')).pdfUrl ? 
        JSON.parse(localStorage.getItem('lastPdfOpened')).pdfUrl : file_url;
  ...
  function getPDFFileNameFromURL(url) {
    var defaultFilename_url = arguments.length > 1 && arguments[1] !== undefined ? arguments[1] : 'document.pdf';
    var defaultFilename = localStorage.getItem('lastPdfOpened') && JSON.parse(localStorage.getItem('lastPdfOpened')).title ? 
          JSON.parse(localStorage.getItem('lastPdfOpened')).title : defaultFilename_url;
  ...
  if (typeof window !== 'undefined' && window['pdfjs-dist/pdffjs/pdf']) {
    pdfjsLib = window['pdfjs-dist/pdffjs/pdf'];
  } else {
    pdfjsLib = require('../pdffjs/pdf.js');
  }
