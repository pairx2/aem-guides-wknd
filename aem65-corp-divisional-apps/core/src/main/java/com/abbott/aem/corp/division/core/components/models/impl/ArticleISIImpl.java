...
@Model(adaptables = {Resource.class, SlingHttpServletRequest.class}, adapters = {ArticleISI.class}, defaultInjectionStrategy = DefaultInjectionStrategy.OPTIONAL)
@Exporter(name = ExporterConstants.SLING_MODEL_EXPORTER_NAME, extensions = ExporterConstants.SLING_MODEL_EXTENSION)
public class ArticleISIImpl implements ArticleISI {
