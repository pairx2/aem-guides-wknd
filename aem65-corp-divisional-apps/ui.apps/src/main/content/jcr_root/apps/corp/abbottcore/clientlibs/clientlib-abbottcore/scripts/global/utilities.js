...
/* Added for horizontal line. added span and text form js to html */
$(document).ready(function () {
    $(".text.a-text--or-on-center .cmp-text").append("<span>(OR)</span>");
    $(".container--account-request-form, .form-container-registration-with-upi").find(".a-input-field--required, .a-input-field--text-require, .a-dropdown__title--required").parent().css("font-weight", "bold")
});