...
(function ($, CUI) {
    var GROUP = "experience-aem",
        ...
        TITLE = "Color Picker",
        ICON = "textColor",
        PICKER_URL = "/apps/cv/division/components/content/eaem-touchui-dialog-rte-color-picker/color-picker-popover/_cq_dialog.html";
    ...
    function addDialogTemplate() {
        ...
        var html = "<iframe width='500px' height='400px' frameBorder='0' src='" + url + "'></iframe>";
