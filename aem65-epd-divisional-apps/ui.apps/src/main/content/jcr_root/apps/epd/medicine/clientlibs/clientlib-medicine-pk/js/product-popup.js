$(document).on("click", ".productlist-page", function (e) {
  ...
  customPopupTrigger($(this));
});

$(document).on("click", ".o-product-section__container", function (e) {
  e.preventDefault();
  if($(this).find('a').attr("href") != undefined) {
   customPopupTrigger($(this).find('a'));
  }
});

function customPopupTrigger(_this) {
  var anchorHref = $(_this).attr("href");
