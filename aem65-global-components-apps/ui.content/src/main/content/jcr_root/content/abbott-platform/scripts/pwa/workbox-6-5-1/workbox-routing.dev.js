var workbox = workbox || {};
workbox.routing = (function (exports, assert_js, logger_js, WorkboxError_js, getFriendlyURL_js) {
    'use strict';
      ...
      findMatchingRoute({
        ...
        for (const route of routes) {
          ...
          if (matchResult) {
            ...
            if ((Array.isArray(params) && params.length === 0) ||  (matchResult.constructor === Object && // eslint-disable-line
            Object.keys(matchResult).length === 0) || (typeof matchResult === 'boolean')) {
