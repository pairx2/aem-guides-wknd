var workbox = workbox || {};
workbox.strategies = (function (exports, assert_js, logger_js, WorkboxError_js, cacheNames_js, getFriendlyURL_js, cacheMatchIgnoreParams_js, Deferred_js, executeQuotaErrorCallbacks_js, timeout_js) {
    'use strict';
    ...
    */
    ...
    class Strategy {
      ...
      async _awaitComplete(responseDone, handler, request, event) {
        ...
        } catch (err) {// Ignore errors, as response errors should be caught via the `response`
